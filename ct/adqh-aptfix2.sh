...
function fix_apt_sources() {
  ...
  # Remove enterprise Deb822 source files entirely; partial edits can corrupt them.
  ...
  # Remove enterprise lines from legacy .list files.
  ...
  # Prefer a single no-subscription definition.
