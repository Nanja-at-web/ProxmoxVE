...
function fix_apt_sources() {
  ...
  # Remove enterprise Deb822 source files entirely. Editing single lines can break the stanza format.
  ...
  # Remove enterprise lines from classic .list files and delete empty leftovers.
  ...
  # Prefer one no-subscription definition.
